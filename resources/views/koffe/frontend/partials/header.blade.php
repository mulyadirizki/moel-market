<header class="pc-header">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div class="dropdown-menu pc-h-dropdown pc-mega-dmenu">
                            ...
                            <div class="col image-block">
                                ...
                                <div class="col">
                                    <img src="{{ url('assets/images/mega-menu/chart.svg') }}" alt="image" class="img-fluid img-charts">
                                </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                >
                                <li
                                    ><a href="#!" class="dropdown-item"><i class="ti ti-shopping-cart"></i> Notification</a></li
                                >
                                </ul>
                            </div>
                            </div>
                        ...
                        >
                            ...
                            <span class="badge bg-success pc-h-badge" id="countCart">0</span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="list-group list-group-flush w-100">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                    <img src="{{ url('assets/images/user/avatar-3.jpg') }}" alt="user-image" class="user-avtar">
                                    </div>
                                    <div class="flex-grow-1 ms-1">
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="d-flex mb-1">
                                <div class="flex-shrink-0">
                                <img src="{{ url('assets/images/user/avatar-2.jpg') }}" alt="user-image" class="user-avtar wid-35">
                                </div>
    ...
    <script>
        ...
        function btnclearsale() {
            sessionStorage.removeItem('dataOrderTemp');
            countCart();
            $.Toast("Berhasil", 'Emptied successfully', "success", {
                has_icon:true,
                has_close_btn:true,
                stack: true,
                fullscreen:false,
