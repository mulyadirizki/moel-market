                  ...
                  <div class="row">
                        ...
                        <div class="card-body position-relative">
                          ...
                          <div class="text-center mt-3">
                            <div class="chat-avtar d-inline-flex mx-auto">
                              <img class="rounded-circle img-fluid wid-70" src="{{ url('assets/images/store/koffea.jpeg') }}"
                                alt="User image">
                            </div>
                            <h5 class="mb-0">Koffea</h5>
                            <button class="btn btn-primary" onclick="printBilling()">Cetak</button>
                            <p class="text-muted text-sm">mulyadirizkiputra10@gmail.com</p>
                            <hr class="my-3">
                            <div class="row g-3">
                              <div class="col-4">
                                <h5 class="mb-0">86</h5>
                            ...
                            <div class="d-inline-flex align-items-center justify-content-between w-100 mb-3">
                              ...
                              <p class="mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b4d5dac7dcd5daf4d3d9d5ddd89ad7dbd9">[email&#160;protected]</a></p>
                            </div>
                            <div class="d-inline-flex align-items-center justify-content-between w-100 mb-3">
                    ...
                    <div class="col-lg-8 col-xxl-9">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <p class="mb-0">Koffea RS Universitas Andalas</p>
                        </div>
                      </div>
                      <div class="card">
                        <div class="card-header">
                            ...
                            <li class="list-group-item px-0">
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <p class="mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bfded1ccd7ded191dbd7878effd8d2ded6d391dcd0d2">[email&#160;protected]</a></p>
                                </div>
                                <div class="col-md-6">
