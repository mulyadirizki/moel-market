                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Dibatalkan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Dibatalkan</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            function load() {
                ...
                var table = $('#data-penjualan-selesai').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'keteranganrefund', name: 'keteranganrefund' },
